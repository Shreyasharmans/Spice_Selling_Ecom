...
<!--  -->
    <div class="form-group col-md-6">
      ...
      <input type="number" class="form-control" name="price" placeholder="Enter Price" id="inputEmail4"><br>
    </div></div><br>
    <div class="form-group">
    <label >Description</label>
    <input type="text" class="form-control" placeholder="Description About Product" name="disc"  style="height:120px;"><br>
  </div>

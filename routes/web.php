...
Route::get('about','UserController@aboutview')->name('about');
Route::get('store','UserController@storeview')->name('store');
Route::get('spice','UserController@spiceview')->name('spice');
